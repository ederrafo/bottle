    ...
    var _pub_static = function (sId) {
        ...
        JH.mergePropertyFrom(_pri, {
            ...
            "drawElm" : function (oData, sKey, targetBox) {//debugger;
                ...
                var sHTML = '<div class="row"><img class="ico" src="/images/lib/json-handle/' + _pro.icoConfig[sType].icoName + '" alt="" /><div class="elmBox"><span class="elmSpan"><span class="elm" title="' + sValue + '">' + sKey + showID + '</span></span></div></div>';
