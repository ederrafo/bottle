...
JH.mod.add(['jsonH.nav'], 'jsonH', function (modName, JH, $$) {
    ...
    var _pub_static = function (sJson) {
        ...
        _main = function () {
            ...
            _pri.checkIcoAsFolderBtn($('#icoAsFolder')[0]);
            _pri.checkShowValueInNav($('#showValueInNav')[0]);
            _pri.checkShowIco($('#showIco')[0]);
        ...
        _uiEvt = function () {
            ...
            $('#createBtn').on('click',_pri.uiEvtCallback.clickCreateBtn)
            ...
            "uiEvtCallback" : {
                ...
                submitEnterForm : function () {
                    try{
                        ...
                        $('#_msgBox').html('');
                        $('#enterValue').css('color', 'rgb(0, 0, 0)');
                    }catch(e) {
                        $('#_msgBox').html(_pri_static.langOut('msg_2'));
//                        _pri.sTempShowValue = _pri.node['enterValue'].value;
...
//                        _pri.hideEnterInputDialog();
                ...
                clickShowValueInNav : function () {
                    _pri.checkShowValueInNav(this);
                },
                clickShowIco : function () {
                    _pri.checkShowIco(this);
                },
                clickIcoAsFolder : function () {
                    _pri.checkIcoAsFolderBtn(this);
                },
