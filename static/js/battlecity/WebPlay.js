...
Layer = Class(
{
    ...
    SetX:
        _FF_?
            ...
            function(v) {this._sty.pixelLeft = this.X = v},

    Y: 0,
    SetY:
        _FF_?
            function(v) {this._sty.top = (this.Y = v) + "px"} :
            function(v) {this._sty.pixelTop = this.Y = v},

    Width: 0,
    SetWidth:
        _FF_?
            function(v) {this._sty.width = (this.Width = v) + "px"} :
            function(v) {this._sty.pixelWidth = this.Width = v},

    Height: 0,
    SetHeight:
        _FF_?
            function(v) {this._sty.height = (this.Height = v) + "px"} :
            function(v) {this._sty.pixelHeight = this.Height = v},
