...
var Scene = Class(
{
    ...
    Scene: function()
    {
        ...
        // 创建地砖层
        //
        this._oMapLayer = new TiledLayer(13, 13, "images/battlecity/Terr.png", 32, 32);
    ...
    SetMapCell: function(c, r, cellID)
    {
        ...
        //
        // cellID 对应 images/battlecity/Terr.png 的图标
        //
        if(cellID == 1)                            // 草
        {
            ...
            if(!spt)
            {
                spt = this._arrGrass[this._numGrass] = new Sprite("images/battlecity/Terr.png", 32, 32);
    ...
    _DrawFrag: function(col, row, val)
    {
        ...
        if(!spt)
        {
            spt = new Sprite("images/battlecity/Frag.png", 16, 16);
