...
var UIGame = Class(Layer,
{
    ...
    UIGame: function()
    {
        ...
        //this._oSound = new Sound("images/battlecity/Open.mid");
        ...
        for(i = 0; i < 20; ++i)
        {
            spt = this.EnemyFlag[i] = new Sprite("images/battlecity/Misc.png", 16, 16);
            spt.SetFrame(10);
        ...
        // 生命图标
        //
        spt = new Sprite("images/battlecity/Misc.png", 16, 16);
        spt.SetFrame(11);
        spt.Move(14, 280);
        this._layInfo.Append(spt);
        ...
        // 旗帜图标
        //
        spt = new Sprite("images/battlecity/Misc.png", 32, 32);
        spt.SetFrame(4);
        spt.Move(14, 352);
        this._layInfo.Append(spt);
