...
var App = window["App"] = Class(
{
    ...
    App: function()
    {
         ...
         * 详细参考WebPlay源文件。
         */
        new Loader(["images/battlecity/Tank.png", "images/battlecity/Terr.png", "images/battlecity/Boom.png", "images/battlecity/Misc.png", "images/battlecity/UI.png", "images/battlecity/Frag.png"])
            .SetListener(this);
    },
